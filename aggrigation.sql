...
SELECT employee_id, emp_name, gender, city, designation, department
FROM employees;

SELECT emp_name, emp_age, employee_id
FROM employees;
    
SELECT * FROM employees; #select all records.


# Aggregation Function COUNT()
/*
	Syntax: 
		select count(col_name)  #it has contain only one elem.
        from table_name
*/
...
/*
	Syntax: 
		select sum(col_name)  #it has contain only one elem.
        from table_name
*/
select sum(emp_age) from employees;
select sum(salary) from employees;
select sum(years_of_experience) from employees;
# Name convention change krna hai to alias (as) de skte hai.
select sum(years_of_experience) as total_exp from employees;


# Aggregation Function AVG()
/*
	# sum(col_name)/count(col_name) = avg
	Syntax: 
		select avg(col_name)  #it has contain only one elem inside the(..).
        from table_name
*/
select sum(emp_age) / count(emp_age) as avg_age from employees;
select avg(emp_age) as avg_age from employees;

# Aggregation Function MIN()
/*
	#
	Syntax: 
		select min(col_name)  #it has contain only one elem inside the(..).
        from table_name
*/
select min(salary) as minsalary from employees;
select min(emp_age) as min_age from employees;
...
/*
	#
	Syntax: 
		select max(col_name)  #it has contain only one elem inside the(..).
        from table_name
*/
select max(salary) as max_salary from employees;
select max(emp_age) as max_age from employees;
